...
output "subnet_id" {
  value = {
    "private-subnet-ad1" = oci_core_subnet.vcn_subnet["sub2"].id
    "private-subnet-ad2" = oci_core_subnet.vcn_subnet["sub4"].id
    "private-subnet-ad3" = oci_core_subnet.vcn_subnet["sub6"].id
    "public-subnet-ad1"  = oci_core_subnet.vcn_subnet["sub1"].id
    "public-subnet-ad2"  = oci_core_subnet.vcn_subnet["sub3"].id
    "public-subnet-ad3"  = oci_core_subnet.vcn_subnet["sub5"].id
  }
}
